...
<body>
	...
	<div class="body">
	    ...
	    <div class="col-main">
			...
			<div class="content-container"><div id="toolbar" class="toolbar" data-module="/admin/shenheteacher"><?php \Common\Common\Auth::get()->showTollbar('admin', 'shenheteacher', 'index') ?></div>
<!-- 表格 -->
<style>
.btn_wish {
    padding: 7px 20px;
...
function wish_close(){
    ...
    $.ajax({
            url:'/admin/shenheteacher/shenhe',
            type:'post',
            data:{
                id:id,
                flag:2
